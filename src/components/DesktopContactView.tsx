...
export default function DesktopContactView({ id, first_name, last_name, phones, onClick, isFavorite, favoriteClick, deleteClick, refreshClick }: ContactClickFavoriteClickDeleteClickProps & RefreshClick) {
    ...
    return (
        <div className={wrapper}>
            ...
            <div className={buttons}>
                ...
                <button onClick={() => { if (!editMode) deleteClick(); setEditMode(false); setContact({ id, first_name, last_name, phones }); if (id === 'new') onClick() }}>
                    {
                        !editMode ?
